...
const PS_P_MAXSPEED = 120; // max |vx| (kept < 127 to avoid int8 overflow in collisions)
...
// --- shared helpers (FXparticleSystem.cpp) ----------------------------------
...
// returns false if the particle has fully left the strip (wraps in place if set)
